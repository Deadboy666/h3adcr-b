#!/usr/bin/env bash
    ...
    HeadcrabCompatibleClientVer=1788652215
	...
	CloudRedirectLib="https://cdn.jsdelivr.net/gh/Selectively11/h3adcr-b@releases/download/linux-test/cloud_redirect.so"
	CloudRedirectCLI="https://cdn.jsdelivr.net/gh/Selectively11/h3adcr-b@releases/download/linux-test/cloud_redirect_cli"
